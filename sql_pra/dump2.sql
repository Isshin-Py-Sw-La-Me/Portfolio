...
INSERT INTO `Class` VALUES (1,'木村'),(2,'近藤'),(3,'桐山'),(4,'高崎');
...
CREATE TABLE `From` (
  `id` int DEFAULT NULL,
  `syussin` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `From` VALUES (1,'東京'),(2,'大阪'),(3,'北海道');
...
INSERT INTO `Student` VALUES (1,'佐藤',3,2),(2,'鈴木',1,3),(3,'高橋',2,4),(4,'田中',4,1);
...
-- Dump completed on 2022-05-11 14:00:01
